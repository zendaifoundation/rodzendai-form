enum ServiceType {
  outbound(
    'ขาไป',
    'ขาไป',
  ), // แก้ไข displayName จาก 'ขาไป (ไปโรงพยาบาล)' เป็น 'ขาไป' เพื่อให้สั้นลงและตรงกับคำที่ใช้ใน UI
  inbound(
    'ขากลับ',
    'ขากลับ',
  ), // แก้ไข displayName จาก 'ขากลับ (กลับจากโรงพยาบาล)' เป็น 'ขากลับ' เพื่อให้สั้นลงและตรงกับคำที่ใช้ใน UI
